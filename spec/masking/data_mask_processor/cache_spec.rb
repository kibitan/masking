...
RSpec.describe Masking::DataMaskProcessor::Cache do
  describe '.fetch_or_store_if_no_cache' do
    subject { described_class.fetch_or_store_if_no_cache('sample_table', proc { 'sample_value' }) }
    ...
    context 'if there is a cache' do
      before { described_class.fetch_or_store_if_no_cache('sample_table', proc { 'cached_value' }) }
