...
RSpec.describe Masking::SQLInsertStatement::Builder do
  describe ".build" do
    ...
    let(:values) do
      [
        instance_double(Masking::SQLInsertStatement::Value, phrase: "(1,'John','john@example.com','berlin')"),
        instance_double(Masking::SQLInsertStatement::Value, phrase: "(2,'Super Chikahiro','kibitan++@example.com','tokyo')")
      ]
    end
